...
Below are the due dates for the project. You may complete your work either in Excel or a Colab notebook (in Python or R).

\noindent Due Dates:
\begin{itemize}
\item February 11: Download daily data for your cryptocurrency and calculate summary statistics for its returns.
\item February 25: Download Fama-French 3 factor data and merge it with your cryptocurrency data.
\item TBD
\end{itemize}

Upload each item above to its respective Brightspace dropbox.
